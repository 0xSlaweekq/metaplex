...
export class ConfigData {
  ...
  creators: 'FMupYBEeU74g86Y4mRJ7Ry8oWZxsRNSrqgQqeg8n3fT' | null;
  ...
  constructor(args: {
    ...
    this.creators = 'FMupYBEeU74g86Y4mRJ7Ry8oWZxsRNSrqgQqeg8n3fT';
...
export class Data {
  ...
  constructor(args: {
    ...
    this.name = 'Cyber Basketball Phase 1';
    // this.name = args.name;
    this.symbol = args.symbol;
    this.uri = args.uri;
    this.sellerFeeBasisPoints = 500;
    // this.sellerFeeBasisPoints = args.sellerFeeBasisPoints;
    this.creators = 'FMupYBEeU74g86Y4mRJ7Ry8oWZxsRNSrqgQqeg8n3fT';
